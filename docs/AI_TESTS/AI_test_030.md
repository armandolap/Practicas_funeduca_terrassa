...
```
  ...
  ✗ POST /projectes {} → 401 (validation) — expected 400 for empty body, got 401
  ✗ PUT /projectes/999999 (nonexistent) → 401 — expected 404, got 401
  ✗ DELETE /projectes/999999 (nonexistent) → 401 — expected 404, got 401
  ✗ POST /projectes → 401 — expected 201 + {id}, got 401 {"message":"No autoritzat"}
  ✓ GET /usuario → 200
  ...
  ✗ POST /usuario → 400 — expected 201 + {id}, got 400 {"error":"Nom d'usuari obligatori"}
  ✓ GET /domicili → 200
  ...
  ✗ POST /callejero (readOnly) → 401 — expected 404/405, got 401
  ...
  ✓ GET /callejero/999999 → 404
  ✗ GET / → 200 — expected 200 + login page, got 200
  ✗ GET /crear-persona.html → 200 — expected 200 + "Creació de Client", got 200
