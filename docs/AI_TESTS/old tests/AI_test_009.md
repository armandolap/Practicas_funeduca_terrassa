...
```
  ...
  ✓ GET /usuario/2 → 200
  ✓ GET /usuario/2 body té id
  ✓ GET /usuario/999999 → 404
  ✓ POST /usuario {} → 400 (validation)
  ✓ PUT /usuario/999999 (nonexistent) → 404
  ✓ DELETE /usuario/999999 (nonexistent) → 404
  ✓ POST /usuario → 201
  ✓ GET /usuario/3 after create → 200
  ✓ GET /usuario/3 camp "Nom" = "Test"
  ✓ PUT /usuario/3 → 200
  ✓ GET /usuario/3 after update → 200
  ✓ GET /usuario/3 after update: "Nom" = "Test"
  ✓ DELETE /usuario/3 → 200
  ✓ GET /usuario/3 (after delete) → 404
  ✓ GET /domicili → 200
  ...
  ✓ POST /domicili → 201
  ✓ GET /domicili/6 after create → 200
  ✓ GET /domicili/6 camp "Tipus_domicili" = "1"
  ✓ PUT /domicili/6 → 200
  ✓ GET /domicili/6 after update → 200
  ✓ GET /domicili/6 after update: "Tipus_domicili" = "1"
  ✓ DELETE /domicili/6 → 200
  ✓ GET /domicili/6 (after delete) → 404
  ✓ GET /familia → 200
  ✓ GET /familia body[0] té id
  ✓ GET /familia/5 → 200
  ✓ GET /familia/5 body té id
  ✓ GET /familia/999999 → 404
  ✓ POST /familia {} → 400 (validation)
  ✓ PUT /familia/999999 (nonexistent) → 404
  ✓ DELETE /familia/999999 (nonexistent) → 404
  ✓ POST /familia → 201
  ✓ GET /familia/6 after create → 200
  ✓ GET /familia/6 camp "Cognom_familiar" = "Test"
  ✓ PUT /familia/6 → 200
  ✓ GET /familia/6 after update → 200
  ✓ GET /familia/6 after update: "Cognom_familiar" = "Test"
  ✓ DELETE /familia/6 → 200
  ✓ GET /familia/6 (after delete) → 404
  ✓ GET /client → 200
  ✓ GET /client body[0] té id
  ✓ GET /client/7 → 200
  ✓ GET /client/7 body té id
  ...
  ✓ POST /client → 201
  ✓ GET /client/9 after create → 200
  ✓ PUT /client/9 → 200
  ✓ GET /client/9 after update → 200
  ✓ GET /client/9 after update: "Nom" = "Maria Actualitzada"
  ✓ DELETE /client/9 → 200
  ✓ GET /client/9 (after delete) → 404
  ✓ GET /tipusVia → 200
  ...
  ✓ GET /callejero/3 → 200
  ✓ GET /callejero/3 nom_complet = "AVINGUDA ABAT MARCET, DE L'"
  ...
  ✓ GET /client/10 after full create → 200
  ✓ GET /client/10 C_edad calculada
  ✓ GET /client/10 Baixa=0
  ✓ GET /client/10 C_temps_a_lentitat="0"
