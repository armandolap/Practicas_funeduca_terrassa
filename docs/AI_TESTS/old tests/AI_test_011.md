...
```
  ...
  ✓ POST /usuario → 201
  ✓ GET /usuario/4 after create → 200
  ✓ GET /usuario/4 camp "Nom" = "Test"
  ✓ PUT /usuario/4 → 200
  ✓ GET /usuario/4 after update → 200
  ✓ GET /usuario/4 after update: "Nom" = "Test"
  ✓ DELETE /usuario/4 → 200
  ✓ GET /usuario/4 (after delete) → 404
  ✓ GET /domicili → 200
