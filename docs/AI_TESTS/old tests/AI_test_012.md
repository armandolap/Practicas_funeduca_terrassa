...
```
  ...
  ✓ POST /projectes → 201
  ✓ GET /projectes/6 after create → 200
  ✓ GET /projectes/6 camp "Nom_projecte" = "Projecte Test 2"
  ✓ PUT /projectes/6 → 200
  ✓ GET /projectes/6 after update → 200
  ✓ GET /projectes/6 after update: "Nom_projecte" = "Projecte Test 2 Actualitzat"
  ✓ GET /projectes/6 after update: "Nom_projecte" = "Projecte Test 2 Actualitzat"
  ✓ DELETE /projectes/6 → 200
  ✓ GET /projectes/6 (after delete) → 404
  ✓ GET /usuario → 200
  ...
  ✓ POST /usuario → 201
  ✓ GET /usuario/5 after create → 200
  ✓ GET /usuario/5 camp "Nom" = "Test"
  ✓ PUT /usuario/5 → 200
  ✓ GET /usuario/5 after update → 200
  ✓ GET /usuario/5 after update: "Nom" = "Test"
  ✓ DELETE /usuario/5 → 200
  ✓ GET /usuario/5 (after delete) → 404
  ✓ GET /domicili → 200
  ...
  ✓ GET /callejero/999999 → 404
  ✗ GET / → 200 — expected 200 + "Creació de Client", got 200
