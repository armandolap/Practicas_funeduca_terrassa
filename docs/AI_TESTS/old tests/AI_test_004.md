...
```
  ...
  ✗ PUT /projectes/2 → 404 — expected 200, got 404 null
  ✓ GET /projectes/2 after update → 200
  ✗ GET /projectes/2 after update: "Nom_projecte" = "Projecte Test 2" — expected "Projecte Test 2 Actualitzat", got "Projecte Test 2"
  ✗ GET /projectes/2 after update: "Nom_projecte" = "Projecte Test 2" — expected "Projecte Test 2 Actualitzat", got "Projecte Test 2"
  ...
  ✓ POST /usuario → 201
  ✓ GET /usuario/2 after create → 200
  ✓ GET /usuario/2 camp "Rol_usuario" = "Test User"
  ✓ PUT /usuario/2 → 200
  ✓ GET /usuario/2 after update → 200
  ✓ GET /usuario/2 after update: "Rol_usuario" = "Test User"
  ...
  ⚠ POST /domicili {} → 500 — endpoint sense validació 400 explícita
  ✓ POST /domicili → 201
  ...
  ⚠ POST /familia {} → 500 — endpoint sense validació 400 explícita
  ✓ POST /familia → 201
  ✓ GET /familia/2 after create → 200
  ✓ PUT /familia/2 → 200
  ✓ GET /familia/2 after update → 200
  ...
  ⚠ POST /client {} → 500 — endpoint sense validació 400 explícita
  ✓ POST /client → 201
  ✓ GET /client/2 after create → 200
  ✓ PUT /client/2 → 200
  ✓ GET /client/2 after update → 200
  ✓ GET /client/2 after update: "Nom" = "Maria Actualitzada"
  ✓ DELETE /client/2 → 200
  ...
  ✓ GET /callejero/115 → 200
  ✓ GET /callejero/115 body té id
